...
public class RTreeInnerNode extends RTreeNode  implements Serializable
{
	...
	{
		int keyIndex = this.findIndex(pushup.key);
	 ...
	 */
	private void insertAt(int index, comparablePolygon key) 
	{
	 ...
	 */
	public void insertLeftAt(int index, comparablePolygon key, RTreeNode leftChild) 
	{
		insertAt(index, key);
	 ...
	 */
	public void insertRightAt(int index, comparablePolygon key, RTreeNode rightChild)
	{
		insertAt(index, key);
	 ...
	 */
	public void merge(comparablePolygon parentKey, RTreeInnerNode foreignNode)
	{
	...
	public RTreeLeafNode getSmallestLeafNode() {
		return getFirstChild().getSmallestLeafNode();
	}
	
	
	public RTreeLeafNode searchLeafNode(comparablePolygon key) 
	{
		return children[findIndex(key)].searchLeafNode(key);
	}
}